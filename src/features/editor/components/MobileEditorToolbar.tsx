    ...
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md border-t border-neutral-200/80 dark:border-neutral-800 px-3 py-2 flex items-center justify-around shadow-lg safe-bottom">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-amber-500 text-neutral-950 font-black active:scale-95 transition-all flex items-center gap-1 shadow-sm cursor-pointer"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="p-3 rounded-2xl bg-blue-50/60 dark:bg-blue-950/30 border border-blue-200/60 dark:border-blue-900/40 text-left flex flex-col gap-1 text-blue-700 dark:text-blue-300"
                >
                  <Printer className="w-5 h-5" />
                  <span className="font-bold text-xs">PDF Studio</span>
                  <span className="text-[10px] opacity-75">Themes &amp; print</span>
                </button>
