...
export const MILESTONES: UpdateMilestone[] = [
  ...
  },
  {
    ...
    summary: 'A landmark platform release: total architectural decomposition with 0 monolithic files > 600 LOC, a 98.8% initial bundle reduction (31 kB entry), standalone PWA installability with 95 offline precached assets, a 20+ formula KaTeX studio, debounced 0ms Mermaid caching, and an Apple/iOS emoji engine on all platforms.',
    icon: Layers,
    ...
    highlights: [
      ...
      { type: 'new', text: 'Apple iOS Emoji Engine: Converts all Unicode emojis and shortcodes (:rocket:, :fire:, :sparkles:) into authentic, high-DPI Apple emojis on all operating systems.' },
