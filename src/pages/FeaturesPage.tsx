...
type PillarId = 'pdf' | 'math' | 'offline' | 'slash' | 'media';
      ...
      <main className="flex-1">
        ...
        <section className="pt-16 pb-12 sm:pt-20 sm:pb-16 text-center max-w-5xl mx-auto px-4 sm:px-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/60 text-xs font-semibold text-blue-700 dark:text-blue-300 mb-5 shadow-2xs">
            ...
            <span className="font-mono uppercase tracking-wider text-[11px]">Architectural Deep Dives &amp; Specs</span>
          </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800/60">
                {[
                  ...
                  <tr 
                    key={idx} 
                    onClick={() => scrollToPillar(row.pillar)}
